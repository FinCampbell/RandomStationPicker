    ...
    document.getElementById('form-container').innerHTML = `
        <div class="container">
            <form onsubmit="handleFormSubmit(event, '/station_by_id')">
                ...
                <input type="text" name="station_id" placeholder="Enter station ID" required>
                <button type="submit">Submit</button>
            </form>
        </div>
    `;
    ...
    document.getElementById('form-container').innerHTML = `
        <div class="container">
            <form onsubmit="handleFormSubmit(event, '/reachable_stations_by_name')">
                ...
                <input type="number" name="total_duration" placeholder="Enter total duration in hours" required>
                <button type="submit">Submit</button>
            </form>
        </div>
    `;
